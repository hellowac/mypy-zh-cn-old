...
You can also use the [files](./config_file.md#files) option in your `mypy.ini` file to specify which
...
[getting-started]: ../mypy/index.md
[command-line]: ./command_line.md

[-m]: ./command_line.md#m
[--module]: ./command_line.md#m

[-p]: ./command_line.md#p
[--package]: ./command_line.md#p
[-c]: ./command_line.md#c
[--command]: ./command_line.md#c